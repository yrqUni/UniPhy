...
class InstrumentedUniPhyBlock(UniPhyBlock):
    ...
    def forward_step(self, x_curr, h_prev, dt, flux_prev):
        ...
        h_log = h_tilde_next.reshape(B, H, W, D).permute(0, 3, 1, 2) 
...
def run_debug():
    ...
    # FIX: Initialize h_state with correct shape (B*H*W, 1, D)
