...
class MovingMNIST(data.Dataset):
    def __init__(self, root, is_train, n_frames_input, n_frames_output, num_objects, num_samples=int(1e10), transform=None):
        '''
        ...
        self.length = num_samples if self.dataset is None else self.dataset.shape[1]
